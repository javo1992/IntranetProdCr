...
namespace IntranetProdCr.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        public EmpresasController(INT_PROD_CRContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'INT_PROD_CRContext.Empresas'  is null.");
            }
            var empresa = await _context.Empresas.FindAsync(id);
            if (empresa != null)
            {
        ...
        {
          return _context.Empresas.Any(e => e.EmCodigo == id);
        }
    }
}
